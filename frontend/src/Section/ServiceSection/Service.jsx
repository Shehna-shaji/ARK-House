      ...
      <div className="section-container">
        ...
        <div className="service-menu">
          <ul className="service-list">
            <li onClick={() => setImage(architecture)}>Architecture</li>
            <li onClick={() => setImage(landscape)}>Landscape</li>
            <li onClick={() => setImage(interior)}>Interior</li>

            <li onClick={() => setImage(design)}>Design</li>
          </ul>
        </div>
